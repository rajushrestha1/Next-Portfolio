      ...
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className="flex justify-center items-center">
          ...
          >
            ...
            <button className="text-white bg-blue-500 hover:scale-110 duration-300 px-5 py-1 m-3 mx-auto flex items-center rounded-full z-10 hover:bg-white hover:text-blue-600">
              Submit
            </button>
          </form>
        </div>
